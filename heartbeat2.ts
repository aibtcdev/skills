// Heartbeat with standard BIP-322 (no varint in tagged hash)
...
// Standard BIP-322 tagged hash (NO varint prefix)
function bip322TaggedHashStandard(message: string): Uint8Array {
...
function bip322BuildToSpendTxId(message: string, scriptPubKey: Uint8Array): Uint8Array {
  const msgHash = bip322TaggedHashStandard(message);
...
console.log("Signature (standard, no varint):", signatureBase64);
