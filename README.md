...
| [stacking](./stacking/) | `stacking/stacking.ts` | PoX-5 STX staking — cycle state and staking status, signer managers, stake / update / unstake STX, and sBTC reward claims. |
