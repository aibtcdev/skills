...
| [yield-dashboard](./yield-dashboard/) | `yield-dashboard/yield-dashboard.ts` | Single view of DeFi positions across Zest, Bitflow, Pillar, stacking — plus YieldAgent x402 yields. Stacks v1 + x402. Mainnet-only. |
