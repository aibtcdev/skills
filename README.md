...
| [zest-liquidation-monitor](./zest-liquidation-monitor/) | `zest-liquidation-monitor/zest-liquidation-monitor.ts` | Monitor Zest Protocol borrow positions for liquidation risk — health factors, LTV ratios, liquidation prices, and at-risk position scanning. Read-only. Mainnet-only. |
